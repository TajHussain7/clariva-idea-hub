...
import { Mail, Lock, ArrowRight, Github, Sparkles, Target, Zap, LayoutDashboard, Settings, FileText, BarChart2, Plus, BrainCircuit } from 'lucide-react';
      ...
      <div className="hidden lg:flex w-1/2 flex-col justify-between relative overflow-hidden bg-[#080E1C] border-r border-white/5 p-12">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-16">
            ...
            <span className="font-heading font-bold text-2xl tracking-tight text-white">Clariva</span>
          </div>
          ...
          <h1 className="font-heading text-4xl md:text-5xl font-bold leading-tight mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white to-white/70">
            Turn raw ideas into<br />validated concepts.
          </h1>
          <p className="text-lg text-white/60 max-w-md mb-12 leading-relaxed">
            The AI co-pilot for ambitious builders. Evaluate, refine, and execute with surgical precision.
          </p>

          <div className="space-y-8">
            {[
              { icon: Target, title: "Precision Scoring", desc: "Multi-dimensional analysis of your product's potential." },
              { icon: Zap, title: "Market Intelligence", desc: "Real-time competitive landscape and positioning insights." },
              { icon: BrainCircuit, title: "AI Strategy", desc: "Actionable recommendations to strengthen your core loop." }
            ].map((feature, i) => (
              <div key={i} className="flex items-start gap-4 group">
                ...
                <div>
                  <h3 className="font-heading font-semibold text-white/90 mb-1">{feature.title}</h3>
        ...
        <div className="w-full max-w-md">
          ...
          <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
            {activeTab === 'register' && (
              <div className="space-y-5 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <div className="space-y-1.5">
                  <label className="text-sm font-medium text-white/80">Primary Focus</label>
                  <div className="relative">
                    <select className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-white appearance-none focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all">
                      <option value="" className="bg-[#0B1120]">Select a domain</option>
                      <option value="saas" className="bg-[#0B1120]">B2B SaaS</option>
                      <option value="consumer" className="bg-[#0B1120]">Consumer App</option>
                      <option value="devtools" className="bg-[#0B1120]">Developer Tools</option>
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#0B1120] px-4 text-white/40 font-medium">Or continue with</span>
            </div>
          </div>
